...
},{"./lib/ReactPropTypesSecret":42,"./lib/has":43,"_process":37}],39:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./checkPropTypes":38,"./lib/ReactPropTypesSecret":42,"./lib/has":43,"_process":37,"object-assign":36,"react-is":46}],41:[function(require,module,exports){
(function (process){(function (){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"./factoryWithThrowingShims":39,"./factoryWithTypeCheckers":40,"_process":37,"react-is":46}],42:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"_process":37}],45:[function(require,module,exports){
/** @license React v16.13.1
...
},{"./cjs/react-is.development.js":44,"./cjs/react-is.production.min.js":45,"_process":37}],47:[function(require,module,exports){
(function (process){(function (){
/**
 * @license React
...
},{"./cjs/react.development.js":47,"./cjs/react.production.min.js":48,"_process":37}],50:[function(require,module,exports){
"use strict";
...
var _modalMove = require("./modal-move");
...
var ContextMenu = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ContextMenu, [{
    ...
    value: function onRemoveButtonClick(event) {
      this.setState({
        modalDialogue: /*#__PURE__*/_react["default"].createElement(_modalRemove.ModalRemove, {
    ...
    value: function render() {
      ...
      }, "View As Text")), /*#__PURE__*/_react["default"].createElement("li", null, /*#__PURE__*/_react["default"].createElement("a", {
        className: "dropdown-item py-2",
        style: {
          cursor: "pointer"
        },
        onClick: this.onMoveButtonClick
      }, "Move")), /*#__PURE__*/_react["default"].createElement("li", null, /*#__PURE__*/_react["default"].createElement("a", {
        className: "dropdown-item py-2",
        style: {
          cursor: "pointer"
        },
      ...
      }, "Media Info")), /*#__PURE__*/_react["default"].createElement("li", null, /*#__PURE__*/_react["default"].createElement("a", {
        className: "dropdown-item py-2",
        style: {
          cursor: "pointer"
        },
        onClick: this.onTranscodeButtonClick
      }, "Transcode to WebM")), /*#__PURE__*/_react["default"].createElement("li", null, /*#__PURE__*/_react["default"].createElement("a", {
        className: "dropdown-item py-2",
        style: {
          cursor: "pointer"
        },
...
ContextMenu.propTypes = {
  appAddress: _propTypes["default"].string,
  fileInfo: _propTypes["default"].object,
  enableUpload: _propTypes["default"].bool
};

},{"./modal-extract-subtitles":51,"./modal-media-info":52,"./modal-move":53,"./modal-remove":54,"./modal-transcode":55,"prop-types":41,"react":49}],51:[function(require,module,exports){
"use strict";
...
},{"react":49}],52:[function(require,module,exports){
"use strict";
    ...
    value: function fetchDataFromServer() {
      ...
      _axios["default"].get(URL).then(function (response) {
        ...
        _this3.setState({
          ...
          jsonHTML: (0, _utils["default"])(JSON.stringify(response.data.content, null, 2))
        });
      })["catch"](function (error) {
        _this3.setState({
          jsonHTML: /*#__PURE__*/_react["default"].createElement("div", {
...
},{"./utils":56,"axios":1,"react":49}],53:[function(require,module,exports){
"use strict";
...
var ModalMove = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ModalMove, [{
    ...
    value: function fetchDataFromServer() {
      ...
      axios({
        ...
        _this3.setState({
          ...
          }, "Unable to move file from ", /*#__PURE__*/_react["default"].createElement("strong", {
            style: {
              wordBreak: "break-all"
            }
          }, payload.get('old_filepath')), " to ", /*#__PURE__*/_react["default"].createElement("strong", {
            style: {
              wordBreak: "break-all"
            }
          }, payload.get('new_filepath')), ":", /*#__PURE__*/_react["default"].createElement("br", null), error.response.data)
        });
      });
    }
  }, {
    ...
    value: function onFileDirChange(event) {
      ...
      if (newVal.endsWith('/')) {
        ...
        this.setState({
          ...
          }, "New directory ", /*#__PURE__*/_react["default"].createElement("strong", {
            style: {
              wordBreak: "break-all"
            }
          }, newVal), " does not end with a ", /*#__PURE__*/_react["default"].createElement("code", null, "/"), ". If submitted, the section after the last ", /*#__PURE__*/_react["default"].createElement("code", null, "/"), " will be interpreted as a part of the new filename by the server, which is usually not desired. To avoid the ambiguity, you need to append a ", /*#__PURE__*/_react["default"].createElement("code", null, "/"), " to the end of the directory to submit."),
    ...
    value: function onFileNameChange(event) {
      ...
      if (newVal.includes('/')) {
        this.setState({
          ...
          }, "New filename ", /*#__PURE__*/_react["default"].createElement("strong", {
            style: {
              wordBreak: "break-all"
            }
          }, newVal), " contains ", /*#__PURE__*/_react["default"].createElement("code", null, "/"), ", which will be interpreted as a separate directory by the server. To avoid ambiguity, this value cannot be submitted."),
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, "Move File")), /*#__PURE__*/_react["default"].createElement("div", {
        className: "modal-body"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "mb-3"
      }, /*#__PURE__*/_react["default"].createElement("label", {
      ...
      }, "Directory"), /*#__PURE__*/_react["default"].createElement("textarea", {
        type: "text",
        className: "form-control",
        rows: "2",
        style: {
        ...
        className: "input-group-text font-monospace"
      }, "Filename\xA0"), /*#__PURE__*/_react["default"].createElement("textarea", {
        type: "text",
        className: "form-control",
        rows: "2",
        style: {
        ...
        className: "accordion-body"
      }, /*#__PURE__*/_react["default"].createElement("ol", null, /*#__PURE__*/_react["default"].createElement("li", null, "The server returns an error message if ", /*#__PURE__*/_react["default"].createElement("a", {
        href: "https://docs.python.org/3/library/os.path.html#os.path.ismount",
        target: "_blank"
      }, "os.path.ismount()"), " returns true;"), /*#__PURE__*/_react["default"].createElement("li", null, "The server calls ", /*#__PURE__*/_react["default"].createElement("a", {
        href: "https://docs.python.org/3/library/shutil.html#shutil.move",
        target: "_blank"
      }, "shutil.move()"), " to do the move;"), /*#__PURE__*/_react["default"].createElement("li", null, "If the destination is on a different filesystem, source file is copied to destination and then removed ", /*#__PURE__*/_react["default"].createElement("strong", null, "(It could take a long time!)"), ";"), /*#__PURE__*/_react["default"].createElement("li", null, "In case of symlinks, a new symlink pointing to the target of src will be created in or as dst and src will be removed."), /*#__PURE__*/_react["default"].createElement("li", null, /*#__PURE__*/_react["default"].createElement("code", null, "Regularize Filename"), " is used to make a filename more machine-friendly: it converts all letters to lowercase, replaces each special character (including space) with a ", /*#__PURE__*/_react["default"].createElement("code", null, "-"), " and then replaces a ", /*#__PURE__*/_react["default"].createElement("code", null, "---"), " with a ", /*#__PURE__*/_react["default"].createElement("code", null, "_"))))))))), /*#__PURE__*/_react["default"].createElement("div", {
        className: "modal-footer"
      }, /*#__PURE__*/_react["default"].createElement("button", {
        type: "button",
        className: "btn btn-secondary",
      ...
      }, "Regularize Filename"), /*#__PURE__*/_react["default"].createElement("button", {
        type: "button",
        className: "btn btn-primary",
...
},{"react":49}],54:[function(require,module,exports){
"use strict";
...
var ModalRemove = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ModalRemove, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, "Remove File")), /*#__PURE__*/_react["default"].createElement("div", {
        className: "modal-body"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "mb-3"
      }, /*#__PURE__*/_react["default"].createElement("span", {
      ...
      }, "Remove file ", /*#__PURE__*/_react["default"].createElement("strong", null, this.state.fileInfo.asset_dir + this.state.fileInfo.filename), "?"), this.state.responseMessage, /*#__PURE__*/_react["default"].createElement("div", {
        className: "accordion my-2",
        id: "accordionRemove"
      }, /*#__PURE__*/_react["default"].createElement("div", {
        className: "accordion-item"
        ...
        target: "_blank"
      }, "os.unlink()"), " if ", /*#__PURE__*/_react["default"].createElement("a", {
        href: "https://docs.python.org/3/library/os.path.html#os.path.islink",
        target: "_blank"
      }, "os.path.islink()"), " returns true;"), /*#__PURE__*/_react["default"].createElement("li", null, "The server calls ", /*#__PURE__*/_react["default"].createElement("a", {
        href: "https://docs.python.org/3/library/os.html#os.remove",
        target: "_blank"
      }, "os.remove()"), " if ", /*#__PURE__*/_react["default"].createElement("a", {
        href: "https://docs.python.org/3/library/os.path.html#os.path.isfile",
        target: "_blank"
      }, "os.path.isfile()"), " returns true;"), /*#__PURE__*/_react["default"].createElement("li", null, "The server calls ", /*#__PURE__*/_react["default"].createElement("a", {
        href: "https://docs.python.org/3/library/os.html#os.rmdir",
        target: "_blank"
      }, "shutil.rmtree()"), " if ", /*#__PURE__*/_react["default"].createElement("a", {
        href: "https://docs.python.org/3/library/shutil.html#shutil.rmtree",
        target: "_blank"
      }, "os.path.isdir()"), " returns true;"), /*#__PURE__*/_react["default"].createElement("li", null, "The serve returns an error if all of the above conditions are not met.")))))))), /*#__PURE__*/_react["default"].createElement("div", {
        className: "modal-footer"
      }, /*#__PURE__*/_react["default"].createElement("button", {
        type: "button",
        className: "btn btn-secondary",
...
},{"react":49}],55:[function(require,module,exports){
"use strict";
...
},{"react":49}],56:[function(require,module,exports){
"use strict";
...
function syntaxHighlight(json) {
  ...
  var pretty_json = json.replace(/("(\\u[a-zA-Z0-9]{4}|\\[^u]|[^\\"])*"(\s*:)?|\b(true|false|null)\b|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?)/g, function (match) {
    var cls = 'number';
  ...
  return /*#__PURE__*/React.createElement("pre", {
    dangerouslySetInnerHTML: pretty_json
  });
}
