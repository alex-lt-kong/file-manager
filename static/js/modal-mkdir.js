...
var ModalMkdir = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ModalMkdir, [{
    ...
    value: function postDataToServer() {
      ...
      axios({
        ...
        _this4.setState({
          ...
          }, "Unable to create new folder ", /*#__PURE__*/_react["default"].createElement("strong", {
            style: {
              wordBreak: "break-all"
            }
          }, payload.get('folder_name')), ":", /*#__PURE__*/_react["default"].createElement("br", null), error.response.data)
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      }, "Input the name of the folder to be created:"), /*#__PURE__*/_react["default"].createElement("input", {
